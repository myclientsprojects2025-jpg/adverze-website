      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-gray-400 mb-4 max-w-md">
              Digital marketing agency based in Namakkal, serving clients across Tamil Nadu. 
              We blend strategy, creativity, and technology to unlock your brand&apos;s potential.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:hello@adverze.com" className="hover:text-purple-400 transition-colors">
                  hello@adverze.com
                </a>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-sm text-gray-400">
            © {currentYear} Adverze. All rights reserved. Crafted with passion in Namakkal.
          </p>
        </div>
      </div>
    </footer>
